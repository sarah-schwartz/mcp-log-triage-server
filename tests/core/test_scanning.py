...
def test_sniff_format_access(tmp_path: Path, write_bytes) -> None:
...
def test_sniff_format_syslog(tmp_path: Path, write_bytes) -> None:
...
def test_sniff_format_jsonl(tmp_path: Path, write_bytes) -> None:
...
def test_sniff_format_bracket(tmp_path: Path, write_bytes) -> None:
...
def test_sniff_format_unknown(tmp_path: Path, write_bytes) -> None:
...
def test_iter_hits_access(tmp_path: Path, write_bytes) -> None:
    path = tmp_path / "access.log"
    lines = [
...
def test_iter_hits_syslog(tmp_path: Path, write_bytes) -> None:
    path = tmp_path / "sys.log"
    lines = [
...
def test_iter_hits_token_scan(tmp_path: Path, write_bytes) -> None:
